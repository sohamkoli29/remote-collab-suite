  ...
  const socialLinks = [
    {
      ...
      href: 'https://x.com/SohamKoli2020',
    },
    {
      name: 'GitHub',
      icon: (
    ...
    },
    {
      ...
      href: 'https://www.linkedin.com/in/soham029',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-lg font-bold text-white">Kaarya Setu</span>
              <p className="text-xs text-gray-400">Remote Work Platform</p>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-9 h-9 bg-gray-800 hover:bg-purple-600 rounded-lg flex items-center justify-center transition-colors duration-200"
                title={social.name}
